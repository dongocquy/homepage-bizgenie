    ...
    <section id="pricing" className="py-5 bg-card">
      <div className="container">
        <div className="text-center mb-5">
          ...
          <h2 className="display-5 fw-bold mb-3">Chọn gói phù hợp với bạn</h2>
          <p className="lead text-secondary">Không có phí ẩn, không có ràng buộc dài hạn</p>
        </div>
        ...
        <div className="row g-4 justify-content-center">
          <div className="col-lg-4 col-md-6">
            <div className="pricing-card pricing-card-enhanced" data-aos="fade-up" data-aos-delay="100">
              <div className="text-center mb-4">
                <h5 className="fw-bold mb-2">Gói Starter</h5>
              ...
              <div className="text-center">
                <a href="https://bizgenie.vn/goi-starter---ai-ghi-so-ke-toan-bizhkd.html" className="btn btn-outline-warning w-100 btn-pricing">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="pricing-card pricing-card-enhanced pricing-card-popular" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="text-center mb-4">
                <h5 className="fw-bold mb-2">Gói Pro</h5>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="pricing-card pricing-card-enhanced" data-aos="fade-up" data-aos-delay="300">
              <div className="text-center mb-4">
                <h5 className="fw-bold mb-2">Gói Premium</h5>
              ...
              <div className="text-center">
                <a href="https://bizgenie.vn/goi-premium---ai-ghi-so-ke-toan-bizhkd.html" className="btn btn-outline-warning w-100 btn-pricing">
                  <span>Đăng ký ngay</span>
                  <i className="fas fa-arrow-right ms-2"></i>
                </a>
              </div>
